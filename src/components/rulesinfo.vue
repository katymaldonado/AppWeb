  ...
  <b-row>
    ...
    <b-card no-body>
      ...
      <p> The common interest that members of the Association share is to inspire youth to practice
          ...
          administrator or referee whose behavior detracts from this purpose is subject to disciplinary 
     ...
     <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-2 variant="dark">FIFA FIELD REGULATIONS</b-button>
      </b-card-header>
    ...
    <b-card no-body>
      ...
      >
      <p>
         <ol>  <li><strong>DIMENSIONS.</strong>strong FIFA Law 1 provides for flexible external field dimensionswithin a given maximum and minimum width and length. 
                            <br>These dimensions should be adhered to for all fields used by teams under 12 and older</li>

                          <li><strong>COMPETITION FIELDS.</strong>Fields used within the competition program must be a minimum of 100 x 60 yards. Leagues, districts or associations participating in the state competition program that are unable to provide a field that meets these minimum requirements must advise the State Competition Board which  will assign its Fields Committee to inspect the field and recommend to the Board whether  or not a waiver of the minimum dimensions should be granted. Teams from leagues, districts or associations that are unable to provide an acceptable field may be
 required to play all their games away.</li>

                          <li><strong>FIELDS USED BY YOUNG AGE GROUPS.</strong>
                              <ol class="b">
                                  <li>U-6 play on a field approximately 20 X 40 yards with no penalty areas.<br> Fields for older age groups should be progressively larger.</li>
                                  <li>U-8 plays on a field 40-50 yards in length and 20-30 yards width.</li>
                                  <li>U-10 play on a field 70-80 yards in length and 40-50 yards in width.</li>
                                  <li>In addition, fields used by young age groups may have their internal dimensions <br>and size of goal similarly modified.</li>
                               </ol>
                          </li>   

                           <br><li><strong>TEAM BENCH AREAS </strong>
                             <ol class="b">
                                 <li>
                                     <dl>
                                          ...
                                          <dd>
                                               <ul class="a">
                                                    <li>The decision for team/spectator placement on the field willbe made by 
                                                    <br>the governing body of that team. A team’s bench area shall consist of that area 
                                                    <br>at least one (1) yard away from the touchline and extending to twenty yards (20)both ways from the halfway line. In the event that field conditions 
                                                    <br>require team benches to be on the same side of the field, a team’s bench area shall
                                                   <br>consist of that area two (2) yards away from the touchline and extending 
                                                    <br>twenty yards one (1) way from the halfway line.</li>

                                                    <li>The home team has first choice as to where it wishes to locate its bench area.
                                                    <br>Coaches and substitutes are required to remain within their bench area during 
                                                    <br>the game. Parents and spectators should occupy the same side of 
                                                    <br>the field as the team they are supporting.</li>
                                                </ul>
                                           </dd>
                                       </dl>
                                   </li>
                                      ...
                                      <dl>
                                         ...
                                         <dd>
                                             <ul class="a">
                                                  ...
                                                  <br>shall be along the same touchline. Each team bench area shall be located
                                                  <br>two yards outside the touchline, beginning not closer than five yards from midfield
                                                  <br>and extending not further than twenty yards from midfield. The home team shall
                                                  <br> have the right to choose the location of its bench area. Coaches and substitutes
                                                  <br>must remain within their team's bench area during the game.</li>
                                         
                                                  <li>Parents and spectators must occupy the side line opposite the team bench areas.
                                                  <br>Supporters of a team must assemble on the side of the midfield facing the team
                                                  <br>bench area of that team. There shall be a buffer zone extending ten yards
                                                  <br>on each side of the midfield that may not be occupied by parents or spectators.
                                                  <br>Match officials shall be empowered to enforce these provisions and may suspend
                                                  <br>or terminate games in the event that any team, coach, parent, or spectator declines
                                                  <br>to abide by requests from match officials to comply with these standards.</li>
                                              </ul>      
                                           </dd>    
                                      </dl>       
                                   </li>
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-3 variant="dark">EQUIPMENT & NUMBER OF PLAYERS</b-button>
      </b-card-header>
    ...
    <b-card no-body>
      ...
      >
       ...
       <p>
         ...
         <br><strong>NUMBER OF PLAYERS</strong>
         <ul class="a">
     ...
     <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-4 variant="dark">SUBSTITUTIONS</b-button>
      </b-card-header>
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-5 variant="dark">CONFISCATED PLAYER PASSES</b-button>
      </b-card-header>
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-6 variant="dark">ALL-PLAY</b-button>
      </b-card-header>
    ...
    <b-card no-body>
      ...
      <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-7 variant="dark">PLAYERS’ EQUIPMENT & MIXED TEAMS</b-button>
      </b-card-header>
    ...
    <b-card no-body>
     ...
     <strong>PLAYERS’ EQUIPMENT</strong>
                  <ul class="a">
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-8 variant="dark">COACHING & GAME TERMINATION</b-button>
      </b-card-header>
    ...
    <b-card no-body>
     ...
     <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-9 variant="dark">CONDITIONS OF REPLAY OF GAMES</b-button>
      </b-card-header>
    ...
    <b-card no-body>
      ...
      <ul class="a">
           ...
           <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-10 variant="dark">REFEREE RESPONSIBLITIES</b-button>
      </b-card-header>
